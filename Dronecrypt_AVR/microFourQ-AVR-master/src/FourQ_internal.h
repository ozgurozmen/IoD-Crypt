...
// Copy quadratic extension field element from flash to RAM, c = a
...
void fp2addsub1271(f2elm_t a, f2elm_t b, f2elm_t c);
...
#define ecccopy_precomp_fixed_base_flash(Q, P); fp2copy1271_flash((Q)->xy, (P)->xy); \
                                                fp2copy1271_flash((Q)->yx, (P)->yx); \
                                                fp2copy1271_flash((Q)->t2, (P)->t2);
