...
*
* Abstract: portable modular arithmetic and other low-level operations for AVR
*
* Modified by Zhe Liu, Geovandro Pereira and Hwajeong Seo
************************************************************************************/
...
#if defined(USE_ASM)
extern void fpcopy1271_flash(felm_t a, felm_t c);
extern void fpcopy1271(felm_t a, felm_t c);
extern void fpzero1271(felm_t a);
extern void fpadd1271(felm_t a, felm_t b, felm_t c);
extern void fpsub1271(felm_t a, felm_t b, felm_t c);
...
extern unsigned int mp_sub(const digit_t* a, const digit_t* b, digit_t* c, unsigned int nwords);
extern void mul32(digit_t* a, digit_t* b, digit_t* c);
extern void mul64(const digit_t* a, const digit_t* b, digit_t* c);
extern void mul256(const digit_t* a, const digit_t* b, digit_t* c);
...
static __inline void fpneg1271(felm_t a)
...
static unsigned int mp_add(digit_t* a, digit_t* b, digit_t* c, unsigned int nwords)
...
static __inline unsigned int add(digit_t* a, digit_t* b, digit_t* c, unsigned int nwords)
{ // Multiprecision addition, c = a+b, where lng(a) = lng(b) = nwords. Returns the carry bit 
    
    return mp_add(a, b, c, nwords);
}
...
//Added for Dronecrypt
void add_mod_order(digit_t* a, digit_t* b, digit_t* c)
...
{ // Reduction modulo the order using Montgomery arithmetic
  // ma = a*Montgomery_Rprime mod r, where a,ma in [0, r-1], a,mc,r < 2^256
